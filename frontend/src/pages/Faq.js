          ...
          <div className="PreguntasFrecuentes">
              ...
              <Card className="card-faq">
                <CardBody className="card-body-faq">
                  <p>
                    ...
                    para activar y contagiar con alegría a las demás empresas y
                    personas.
                  </p>
                </CardBody>
              </Card>
            ...
            >
              <Card className="card-faq">
                <CardBody className="card-body-faq">
                  <p>
                    Se considera vegano todo aquel producto cuyos ingredientes y
                    procesos no provengan de animales ni de sus derivados.
                  </p>
                </CardBody>
              </Card>
            </Collapse>
            ...
            >
              <Card className="card-faq">
                <CardBody className="card-body-faq">
                  <p>
                    {" "}
                    MercadoPago es la plataforma de pago online líder de América
                    Latina y garantiza la seguridad en todas las operaciones que
                    se generen a través de su sistema. Cuenta con un sistema de
                    privacidad que protege los datos de la tarjeta y con un
                    programa de protección al comprador. Si surgiera algún
                    inconveniente con la compra, la plataforma te devuelve el
                    100% del dinero.
                  </p>
                </CardBody>
              </Card>
          ...
          >
            <Card className="card-faq">
              <CardBody className="card-body-faq">
                <p>
                  {" "}
                  El envio a domicilio tiene un costo estimado para envios en
                  capital federal y otro para el interior del país. El retiro
                  personal por nuestro local no tiene costos extras, aún así se
                  encuientra temporalmente suspendido todo retiro de forma
                  personal.
                </p>
              </CardBody>
            </Card>
            ...
            <Card className="card-faq">
              <CardBody className="card-body-faq">
                <p>
                  ...
                  lo tanto, quedan suspendidos los retiros en nuestro local. En
                  el caso de que se requiera una excepción pueden escribirnos a
                  feliceslasvacas@gmail.com para encontrar alternativas y
